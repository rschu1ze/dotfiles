...
alias make_rel_slim="cmake ${CH_SHARED_LIBS} ${CH_SLIM_BUILD_OPTIONS} ${CH_BUILD_TYPE_RELWITHDEBINFO} ${CH_PATH_TO_SOURCE_AND_BUILD}"

alias make_dbg_fat="cmake ${CH_SHARED_LIBS} ${CH_FAT_BUILD_OPTIONS} ${CH_BUILD_TYPE_DEBUG} ${CH_PATH_TO_SOURCE_AND_BUILD}"

alias make_rel_fat="cmake ${CH_SHARED_LIBS} ${CH_FAT_BUILD_OPTIONS} ${CH_BUILD_TYPE_RELWITHDEBINFO} ${CH_PATH_TO_SOURCE_AND_BUILD}"
