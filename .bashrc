...
CH_FAT_BUILD_OPTIONS="-DENABLE_S3=1 -DENABLE_AVRO=1 -DENABLE_EMBEDDED_COMPILER=1 -DENABLE_GRPC=1 -DENABLE_PARQUET=1 -DENABLE_ROCKSDB=1 -DENABLE_MYSQL=0 -DENABLE_KAFKA=1 -DENABLE_PROTOBUF=1" # MySQL: "The deprecated ucontext routines require _XOPEN_SOURCE to be defined"
