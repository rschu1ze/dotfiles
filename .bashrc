...
CH_FAT_BUILD_OPTIONS="-DENABLE_EMBEDDED_COMPILER=1 -DENABLE_LIBRARIES=1 -DENABLE_MYSQL=0" # MySQL: "The deprecated ucontext routines require _XOPEN_SOURCE to be defined"
